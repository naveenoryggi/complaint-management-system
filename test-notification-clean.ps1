...
# =====================================================
# CATEGORY 1: EVENT TYPES TESTING
# =====================================================
Write-Host "=====================================================" -ForegroundColor Cyan
...
# Test 10: Get rules for event type
...
# =====================================================
# CATEGORY 2: COMMUNICATION TEMPLATES
# =====================================================
Write-Host "=====================================================" -ForegroundColor Cyan
...
$newTemplate = @{
    ...
    body = "Dear {{AssignedTo}}, Your complaint {{ComplaintNumber}} has been updated. Current status: {{Status}}."
    htmlBody = "<p>Dear {{AssignedTo}},</p><p>Your complaint <strong>{{ComplaintNumber}}</strong> has been updated.</p>"
...
# Test 25: Validation - Missing name
...
# Test 28: Try to modify system template
...
# Test 40: Validation - Invalid event type
...
# Test 41: Validation - Invalid template
...
# Test 42: Validation - ID mismatch
